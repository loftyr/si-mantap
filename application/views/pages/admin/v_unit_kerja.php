            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="tbl_1" class="table table-bordered costum-hover">
                        <thead>
                            <tr>
                                <th class="text-center" style="width: 130px;" data-text="Kode Unit Kerja">Kode Unit Kerja</th>
                                <th class="text-center" style="width: 150px;" data-text="Nama Unit Kerja">Nama Unit Kerja</th>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="Kd_Unit">Kode Unit Kerja</label>
                                    <input type="text" class="form-control" id="Kd_Unit" name="Kd_Unit" placeholder="Enter Kode Unit" required>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="Nama_Unit">Nama Unit Kerja</label>
                                    <input type="text" class="form-control" id="Nama_Unit" name="Nama_Unit" placeholder="Enter Nama Unit">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
