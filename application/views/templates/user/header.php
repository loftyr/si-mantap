    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand costum-bg-main-header">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('portaluser/Dashboard/out') ?>">
                        Logout
                    </a>
                </li>
            </ul>
        ...
        <aside class="main-sidebar custom-bg-aside elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">Si Duma Ke Kota</a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url(@$_uri . "/Data-Umk-Lurah") ?>" class="nav-link">
                                <i class="nav-icon fas fa-home"></i>
                                <p>Upload Data UMK Lurah</p>
                            </a>
                        </li>
                    </ul>
                </nav>
