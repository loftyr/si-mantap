...
class Pengumuman_Admin extends CI_Controller
{
    ...
    public function index()
    {
        ...
        /** Data Footer */
        $datafooter['Js']       = "s_pengumuman_admin.js"; // Costum JavaScript

        /** Data Content */
        $datacontent["_uri"]    = "PortalAdmin";

        $this->load->view('templates/admin/header', $dataheader); // Header
        $this->load->view('pages/admin/v_pengumuman_admin', $datacontent); // Content
    ...
    public function getData()
    {
        ...
        foreach ($list as $field) {
            ...
            $Link = '<a href="' . base_url("Pengumuman/Lihat/" . $field->Link) . '" target="_blank">' . $field->Link . '</a>';
    ...
    public function saveData($Method)
    {
        ...
        $Url = preg_replace('/([^a-z0-9]+)/i', '-', strtolower($this->input->post('Judul')));
