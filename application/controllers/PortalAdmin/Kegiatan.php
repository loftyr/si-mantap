...
class Kegiatan extends CI_Controller
{
    ...
    public function getData()
    {
        ...
        foreach ($list as $field) {
            ...
            $Link = '<a href="' . base_url("Portal-Kegiatan/Lihat/" . $field->Link) . '" target="_blank">' . $field->Nomor . '</a>';
    ...
    public function saveData($Method)
    {
        ...
        $Url = preg_replace('/([^a-z0-9]+)/i', '-', strtolower($this->input->post('Kegiatan')));
