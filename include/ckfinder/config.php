...
$config['licenseKey']  = '*C?E-*1**-7**D-*7**-*6**-4*8*-3**K';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'localhost/si-pasti/CKEditor/FileUpload',
    'root'         => "../../../../../CKEditor/FileUpload", // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
